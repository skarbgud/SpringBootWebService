...
import com.gyuhyeong.example.springboot.config.auth.SecurityConfig;
...
)   // 스프링 테스트 어노테이션 중 Spring MVC에 집중할 수 있는 어노테이션. @Controller, @ControllerAdvice등을 사용할 수 있다. @Service, @Component, @Repository등은 사용x. 여기서는 컨트롤러만 사용하기 때문에 선언
